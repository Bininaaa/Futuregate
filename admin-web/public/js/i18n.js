...
const TRANSLATIONS = {
  ...
  'nav.earlyAccess': { ar: 'الوصول المبكر', fr: 'Accès anticipé' },
  ...
  'page.earlyAccess.title': { ar: 'الوصول المبكر', fr: 'Accès anticipé' },
  'page.earlyAccess.eyebrow': { ar: 'بريميوم', fr: 'Premium' },
  ...
  'dash.earlyAccess': { ar: 'الوصول المبكر', fr: 'Accès anticipé' },
  ...
  'dash.pendingEarlyAccess': { ar: 'طلبات الوصول المبكر', fr: 'Demandes d’accès anticipé' },
  ...
  'dash.earlyAccessControl': { ar: 'التحكم في الوصول البريميوم', fr: 'Contrôle de l’accès premium' },
  'dash.earlyAccessControlCopy': { ar: 'تابع اعتماد المنشورات، والطلب المقفل، ونية الترقية عبر المنصة.', fr: 'Suivez l’adoption des posts, la demande verrouillée et l’intention de mise à niveau sur la plateforme.' },
  'dash.manageEarlyAccess': { ar: 'إدارة الطلبات', fr: 'Gérer les demandes' },
  'dash.totalPosts': { ar: 'إجمالي المنشورات', fr: 'Total des posts' },
  'dash.normalPosts': { ar: 'منشورات عادية', fr: 'Posts normaux' },
  'dash.pendingEarly': { ar: 'مبكر قيد الانتظار', fr: 'Anticipé en attente' },
  'dash.approvedEarly': { ar: 'مبكر مقبول', fr: 'Anticipé approuvé' },
  'dash.rejectedEarly': { ar: 'مبكر مرفوض', fr: 'Anticipé refusé' },
  'dash.expiredEarly': { ar: 'مبكر منتهي', fr: 'Anticipé expiré' },
  'dash.lockedClicks': { ar: 'نقرات مقفلة', fr: 'Clics verrouillés' },
  'dash.upgradeClicks': { ar: 'نقرات الترقية', fr: 'Clics de mise à niveau' },
  'dash.postsUsingEarlyAccess': { ar: 'منشورات تستخدم الوصول المبكر', fr: 'Posts utilisant l’accès anticipé' },
  'dash.premiumApplicationsVsFree': { ar: 'طلبات بريميوم مقابل مجانية', fr: 'Candidatures premium vs gratuites' },
  'dash.upgradeConversionIndicators': { ar: 'مؤشرات التحويل للترقية', fr: 'Indicateurs de conversion premium' },
  'dash.ofAllPosts': { ar: 'من كل المنشورات', fr: 'de tous les posts' },
  'dash.premiumFreeValue': { ar: '{premium} بريميوم / {free} مجاني', fr: '{premium} premium / {free} gratuites' },
  'dash.upgradeIndicatorsValue': { ar: '{views} مشاهدة للنافذة، {rate}% نقروا على الترقية', fr: '{views} vues de la fenêtre, {rate}% ont cliqué sur la mise à niveau' },
  ...
  'dash.quickEarlyAccess': { ar: 'الوصول المبكر', fr: 'Accès anticipé' },
  'dash.quickEarlyAccessCopy': { ar: 'وافق على نوافذ الظهور البريميوم.', fr: 'Approuver les fenêtres de visibilité premium.' },
  ...
  'dash.topEarlyRequested': { ar: 'الشركات الأكثر طلبًا للوصول المبكر', fr: 'Entreprises avec le plus de demandes d’accès anticipé' },
  'dash.topEarlyApproved': { ar: 'الشركات الأكثر قبولًا', fr: 'Entreprises avec le plus d’approbations' },
  'dash.topEarlyRejected': { ar: 'الشركات الأكثر رفضًا', fr: 'Entreprises avec le plus de refus' },
  'dash.requests': { ar: 'طلبات', fr: 'demandes' },
  'dash.approvals': { ar: 'موافقات', fr: 'approbations' },
  'dash.rejections': { ar: 'رفض', fr: 'refus' },
  'dash.unknownCompany': { ar: 'شركة غير معروفة', fr: 'Entreprise inconnue' },

  // ─── Early access ──────────────────────────────────────
  'earlyAccess.pageTitle': { ar: 'الوصول المبكر · مسؤول FutureGate', fr: 'Accès anticipé · Admin FutureGate' },
  'earlyAccess.label': { ar: 'الوصول المبكر', fr: 'Accès anticipé' },
  'earlyAccess.modalTitle': { ar: 'طلب الوصول المبكر', fr: 'Demande d’accès anticipé' },
  'earlyAccess.eyebrow': { ar: 'قائمة بريميوم', fr: 'File premium' },
  'earlyAccess.title': { ar: 'التحكم في الوصول المبكر', fr: 'Contrôle de l’accès anticipé' },
  'earlyAccess.copy': { ar: 'راجع طلبات الشركات للظهور البريميوم المبكر، وافق على نافذة القفل، أو أعد المنشورات إلى النشر العادي.', fr: 'Examinez les demandes d’entreprises pour une visibilité premium anticipée, approuvez la fenêtre verrouillée ou remettez les posts en publication normale.' },
  'earlyAccess.searchPlaceholder': { ar: 'ابحث بالعنوان أو الشركة أو الموقع أو النوع أو الحالة أو التعويض', fr: 'Rechercher par titre, entreprise, lieu, type, statut ou rémunération' },
  'earlyAccess.details': { ar: 'التفاصيل', fr: 'Détails' },
  'earlyAccess.approve': { ar: 'موافقة', fr: 'Approuver' },
  'earlyAccess.reject': { ar: 'رفض', fr: 'Refuser' },
  'earlyAccess.makeNormal': { ar: 'جعله عاديًا', fr: 'Rendre normal' },
  'earlyAccess.pending': { ar: 'قيد الانتظار', fr: 'En attente' },
  'earlyAccess.approved': { ar: 'مقبول', fr: 'Approuvé' },
  'earlyAccess.rejected': { ar: 'مرفوض', fr: 'Refusé' },
  'earlyAccess.expired': { ar: 'منتهي', fr: 'Expiré' },
  'earlyAccess.none': { ar: 'بدون', fr: 'Aucun' },
  'earlyAccess.all': { ar: 'الكل', fr: 'Tout' },
  'earlyAccess.total': { ar: 'الإجمالي', fr: 'Total' },
  'earlyAccess.untitled': { ar: 'فرصة بدون عنوان', fr: 'Opportunité sans titre' },
  'earlyAccess.companyNotAdded': { ar: 'لم تتم إضافة الشركة', fr: 'Entreprise non ajoutée' },
  'earlyAccess.locationNotSpecified': { ar: 'الموقع غير محدد', fr: 'Lieu non précisé' },
  'earlyAccess.unknownTime': { ar: 'وقت غير معروف', fr: 'Heure inconnue' },
  'earlyAccess.featured': { ar: 'مميز', fr: 'À la une' },
  'earlyAccess.hidden': { ar: 'مخفي', fr: 'Masqué' },
  'earlyAccess.noResultsTitle': { ar: 'لا توجد نتائج في هذا العرض', fr: 'Aucun résultat dans cette vue' },
  'earlyAccess.noResultsBody': { ar: 'جرّب حالة أخرى أو عبارة بحث مختلفة.', fr: 'Essayez un autre statut ou un autre terme de recherche.' },
  'earlyAccess.emptyTitle': { ar: 'لا توجد طلبات وصول مبكر بعد', fr: 'Aucune demande d’accès anticipé' },
  'earlyAccess.emptyBody': { ar: 'ستظهر هنا طلبات الشركات للظهور البريميوم المبكر بمجرد إرسالها.', fr: 'Les demandes d’entreprises pour une visibilité premium anticipée apparaîtront ici dès leur envoi.' },
  'earlyAccess.couldNotLoad': { ar: 'تعذّر تحميل طلبات الوصول المبكر.', fr: 'Impossible de charger les demandes d’accès anticipé.' },
  'earlyAccess.unableToLoad': { ar: 'تعذّر التحميل', fr: 'Chargement impossible' },
  'earlyAccess.company': { ar: 'الشركة', fr: 'Entreprise' },
  'earlyAccess.type': { ar: 'النوع', fr: 'Type' },
  'earlyAccess.status': { ar: 'الحالة', fr: 'Statut' },
  'earlyAccess.requested': { ar: 'تم الطلب', fr: 'Demandé' },
  'earlyAccess.reviewed': { ar: 'تمت المراجعة', fr: 'Examiné' },
  'earlyAccess.publicVisibility': { ar: 'الظهور العام', fr: 'Visibilité publique' },
  'earlyAccess.delayWindow': { ar: 'نافذة التأخير', fr: 'Fenêtre de délai' },
  'earlyAccess.compensation': { ar: 'التعويض', fr: 'Rémunération' },
  'earlyAccess.notSpecified': { ar: 'غير محدد', fr: 'Non précisé' },
  'earlyAccess.notReviewedYet': { ar: 'لم تتم المراجعة بعد', fr: 'Pas encore examiné' },
  'earlyAccess.notScheduled': { ar: 'غير مجدول', fr: 'Non planifié' },
  'earlyAccess.notSet': { ar: 'غير مضبوط', fr: 'Non défini' },
  'earlyAccess.description': { ar: 'الوصف', fr: 'Description' },
  'earlyAccess.rejectionReason': { ar: 'سبب الرفض', fr: 'Motif du refus' },
  'earlyAccess.requirements': { ar: 'المتطلبات', fr: 'Exigences' },
  'earlyAccess.benefits': { ar: 'الفوائد', fr: 'Avantages' },
  'earlyAccess.tags': { ar: 'الوسوم', fr: 'Tags' },
  'earlyAccess.approvePrompt': { ar: 'وافق على الوصول المبكر لـ "{title}". عدد ساعات التأخير:', fr: 'Approuver l’accès anticipé pour « {title} ». Heures de délai :' },
  'earlyAccess.rejectPrompt': { ar: 'ارفض الوصول المبكر لـ "{title}". السبب اختياري:', fr: 'Refuser l’accès anticipé pour « {title} ». Motif facultatif :' },
  'earlyAccess.normalConfirm': { ar: 'إعادة "{title}" إلى النشر العادي؟', fr: 'Remettre « {title} » en publication normale ?' },
  'earlyAccess.approvedToast': { ar: 'تمت الموافقة على الوصول المبكر.', fr: 'Accès anticipé approuvé.' },
  'earlyAccess.rejectedToast': { ar: 'تم رفض الوصول المبكر.', fr: 'Accès anticipé refusé.' },
  'earlyAccess.normalToast': { ar: 'تمت إعادة المنشور إلى الوضع العادي.', fr: 'Post remis en publication normale.' },
  'earlyAccess.actionFailed': { ar: 'فشل الإجراء.', fr: 'Action échouée.' },
  'earlyAccess.activityApproved': { ar: 'تمت الموافقة على الوصول المبكر لمدة {hours} ساعة.', fr: 'Accès anticipé approuvé pour {hours} h.' },
  'earlyAccess.activityRejected': { ar: 'تم رفض طلب الوصول المبكر.', fr: 'Demande d’accès anticipé refusée.' },
  'earlyAccess.activityRemoved': { ar: 'تمت إزالة الوصول المبكر من هذه الفرصة.', fr: 'Accès anticipé retiré de cette opportunité.' },
