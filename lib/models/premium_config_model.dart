class PremiumConfigModel {
  ...
  factory PremiumConfigModel.fromMap(Map<String, dynamic> map) {
    return PremiumConfigModel(
      ...
      durationDays: _parseInt(map['premiumPassDurationDays'], defaults.durationDays),
      freeSavedLimit: _parseInt(map['freeSavedItemsLimit'], defaults.freeSavedLimit),
      premiumSavedLimit: _parseInt(map['premiumSavedItemsLimit'], defaults.premiumSavedLimit),
